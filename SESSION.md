...
- T-011 已提交为 `5cba42d`；登录入口可见性修订（E-T011-002）已完成验证（87 个测试、lint、tsc、build 通过），等待用户批准后提交。
